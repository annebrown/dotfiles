...
New linux host config on Android, Chromebook, Win11, RasPi, xOS, and iOS.  See [Create New Dev Env](https://www.github.com/annebrown/docs-priv/workflows/new-dev-envs/README.md).
